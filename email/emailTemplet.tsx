import {
  ...
  export default function AWSVerifyEmail({
    ...
    return (
      <Html>
        <Head />
        <Preview>new30 Email Verification {username}</Preview>
        <Body style={main}>
          <Container style={container}>
            <Section style={coverSection}>
    
              <Section style={upperSection}>
                <Heading style={h1}> new30 Verify your email address</Heading>
                <Text style={mainText}>
                ...
                <Section style={verificationSection}>
                  <Text style={verifyText}>Verification code {username}</Text>
